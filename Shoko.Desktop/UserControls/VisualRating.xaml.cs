...
namespace Shoko.Desktop.UserControls
{
    ...
    public partial class VisualRating : UserControl
    {
        ...
        private static void ratingChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            try
            {
                string packUriFullStar = $"pack://application:,,,/{System.Reflection.Assembly.GetExecutingAssembly().GetName().Name};component/Images/star_48.png";
                string packUriHalfStar = $"pack://application:,,,/{System.Reflection.Assembly.GetExecutingAssembly().GetName().Name};component/Images/star_half_48.png";
                string packUriStarOff = $"pack://application:,,,/{System.Reflection.Assembly.GetExecutingAssembly().GetName().Name};component/Images/star_off_48.png";
