...
namespace Shoko.Desktop.Downloads
{
    public class TorrentSourceVM : INotifyPropertyChanged
    {
        ...
        public string TorrentSourceName => EnumTranslator.TorrentSourceTranslated(TorrentSource);

        public string TorrentSourceNameShort => EnumTranslator.TorrentSourceTranslatedShort(TorrentSource);
