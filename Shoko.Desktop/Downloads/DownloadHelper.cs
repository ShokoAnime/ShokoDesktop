...
namespace Shoko.Desktop.Downloads
{
    public class DownloadHelper
    {
        ...
        public static List<TorrentLinkVM> SearchTorrents(DownloadSearchCriteria search)
        {
            ...
            {
                if (VM_UserSettings.Instance.BakaBTOnlyUseForSeriesSearches &&
                !string.IsNullOrEmpty(VM_UserSettings.Instance.BakaBTUsername) && !string.IsNullOrEmpty(VM_UserSettings.Instance.BakaBTPassword))
                {
                    onlyFullSites = true;
                ...
                if (VM_UserSettings.Instance.AnimeBytesOnlyUseForSeriesSearches &&
                !string.IsNullOrEmpty(VM_UserSettings.Instance.AnimeBytesUsername) && !string.IsNullOrEmpty(VM_UserSettings.Instance.AnimeBytesPassword))
                {
                    onlyFullSites = true;
            ...
            if (!onlyFullSites)
            {
                foreach (TorrentSourceVM src in VM_UserSettings.Instance.SelectedTorrentSources)
                {
                    foreach (TorrentSourceVM srcCur in VM_UserSettings.Instance.CurrentSearchTorrentSources)
                    {
                ...
                foreach (TorrentSourceVM src in VM_UserSettings.Instance.CurrentSearchTorrentSources)
                {
