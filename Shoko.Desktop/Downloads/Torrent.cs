...
namespace Shoko.Desktop.Downloads
{
    public class Torrent
    {
        ...
        public string SizeFormatted => Utils.FormatByteSize(Size);

        public string DownloadSpeedFormatted => Utils.FormatByteSize((long)DownloadSpeed) + "/sec";

        public string UploadSpeedFormatted => Utils.FormatByteSize((long)UploadSpeed) + "/sec";

        public string DownloadedFormatted => Utils.FormatByteSize((long)Downloaded);

        public string UploadedFormatted => Utils.FormatByteSize((long)Uploaded);
